...
import {PPSwap} from "../..//src/010-reorg-attack/PPSwap.sol";
import {TokenB} from "../../src/010-reorg-attack/TokenB.sol";
import {TokenBFactory} from "../../src/010-reorg-attack/TokenBFactory.sol";
    ...
    function simulateDeployWithReorg() public {
        ...
        tokenB = TokenB(
            calculateDeploymentAddress(
                address(tokenBFactory),
                salt_,
                type(TokenB).creationCode,
                address(ppswap)
            )
        );
